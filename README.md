...
```bash
docker run -v /my/path/to/problems:/problems ghcr.io/portfolio-solver-platform/parasol:latest <command>
```
...
The same can be done for FICO Xpress and Gurobi, instead search for "Xpress" and "Gurobi", respectively.
